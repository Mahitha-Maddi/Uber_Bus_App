...
function Home(props) {
  ...
  return (
    <div className={classes.root}>
      <h1 className="heading" color="black">
        Welcome to UberBus
      </h1>
      <div class="carousel-wrapper">
            ...
            {/* <Carousel fade>
        <Carousel.Item>
          <img className="d-block w-100" src={uber1} alt="First slide" width="800px" height="600px"/>
          <Carousel.Caption>
            <h3>Adding a Joy to your Journey</h3>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img className="d-block w-100" src={uber2} alt="Second slide" width="800px" height="600px"/>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={uber3} alt="Third slide" width="800px" height="600px"/>
        ...
        <Carousel.Item>
          <img className="d-block w-100" src={uber4} alt="Fourth slide" width="800px" height="600px"/>
