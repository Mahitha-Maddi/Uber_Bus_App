...
export default function SeatSelection() {
    ...
    return (
     ...
     {checkout ? (<PayPal />) : (<button style={{ backgroundColor: "black" }} onClick={e => { if (window.confirm('Are you sure you want to book a ride?'))handleSubmitDetails(e)}} className="btn btn-info seatBT">checkout
                                    </button>)} 
